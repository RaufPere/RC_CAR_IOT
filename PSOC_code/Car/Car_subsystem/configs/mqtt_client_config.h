...
#define MQTT_BROKER_ADDRESS               "api.allthingstalk.io"
...
#define MQTT_USERNAME                     "maker:4Q7A7BfBfKjja5HNKxeLUUFXN429PotKxe1WNVCS"
#define MQTT_PASSWORD                     "Darren"

/********************* MQTT MESSAGE CONFIGURATION MACROS **********************/
/* The MQTT topics to be used by the publisher and subscriber. */
#define MQTT_PUB_TOPIC                    "device/9iWQhUO01zAzTWerwXReY0F1/asset/MPU6050/state"
#define MQTT_SUB_TOPIC                    "device/9iWQhUO01zAzTWerwXReY0F1/asset/MPU6050/state"
 ...
 */
#define MQTT_SNI_HOSTNAME 		"api.allthingstalk.io"
